...
do
    function Library.new(info)
        ...
        local function makeLibrary()
            ...
            Converted["_Creator"].Value = "Nanderez#4258"
            ...
            Converted["_B"].Text = "Red Theme UI-Library" -- please don't remove this, this is open sourced and I leave this here so that users can know the name of the UI library if they are interested in it
            ...
            Converted["_A"].Text = "AWP: Nanderez#4258"
...
print("Atlas UI Library v"..VERSION.." by Nanderez#4258 has initiated")
